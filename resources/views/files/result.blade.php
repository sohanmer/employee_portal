...
@section('content')
    ...
    <div style="height:4em">
            <div class="container">
                    <div class=" font-weight-bold ml-4 d-inline-block"><h4><a href="/home" style="text-decoration:none"><strong>HOME </strong></a><strong>/ Search Result</strong></h4></div>   
                    ...
                    @foreach($allRecord as $file)
                        ...
                        <div class="modal fade" id="renamelist{{$file->id}}" tabindex="-1" role="dialog" aria-labelledby="rename" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <h5 class="modal-title" id="renamelist">Rename</h5>
                                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                      </button>
                                    </div>
